...
import com.example.appfilmes.Data.api.POSTER_BASE_URL
...
class SingleMovie : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        movieRepository = apiService?.let { MovieDetailsRepository(it) }!!
   ...
   fun bindUI(it: MovieDetails?) {
       ...
       val formatCurrencyPrecision = NumberFormat.getCurrencyInstance(Locale.US)
           movie_budget.text = formatCurrencyPrecision.format(it.budget)
           movie_revenue.text = formatCurrencyPrecision.format(it.revenue)
